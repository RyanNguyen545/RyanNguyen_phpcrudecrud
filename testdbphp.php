...
$conn = new mysqli('localhost', '', '', 'employees' );
...
For more information on connecting PHP to MySQL click here: <a href='https://www.php.net/manual/en/book.mysqli.php'>mysqli Database Connector</a>
</body>
</html>
